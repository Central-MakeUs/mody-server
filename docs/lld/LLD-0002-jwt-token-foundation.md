...
- 토큰 응답 DTO: `TokenDto(id, accessToken, refreshToken, personalInfoCompleted, mainAccessible, groupOnboardingCompleted)`.
...
- `TokenDto`
  ...
  - `groupOnboardingCompleted`: 그룹 생성 또는 참여 완료 이력 여부. 기본값은 `false`.
- `JwtProperties`
