...
class OAuthServiceTest {
    ...
    void loginByProviderToken() {
        ...
        given(memberProcessor.ensure(profile)).willReturn(new OAuthMemberResult(1L, true, true, true));
        ...
        assertThat(result).isEqualTo(TokenDto.of(1L, "access", "refresh", true, true, true));
